...
*                  company_code     TYPE string
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS lc_template_bs1 TYPE string VALUE 'zsd_bs_tax_invoice/zsd_bs_tax_invoice'."'zpo/zpo_v2'."
    CONSTANTS lc_template_bs2 TYPE string VALUE 'zsd_bs_tax_invoice2/zsd_bs_tax_invoice2'."'zpo/zpo_v2'."
    CONSTANTS lc_template_bs3 TYPE string VALUE 'zsd_bs_tax_invoice3/zsd_bs_tax_invoice3'."'zpo/zpo_v2'."
    CONSTANTS lc_template_ec1 TYPE string VALUE 'zsd_ec_tax_invoice/zsd_ec_tax_invoice'.
    CONSTANTS lc_template_ec2 TYPE string VALUE 'zsd_ec_tax_invoice2/zsd_ec_tax_invoice2'.
    CONSTANTS lc_template_ec3 TYPE string VALUE 'zsd_ec_tax_invoice3/zsd_ec_tax_invoice3'.
    CONSTANTS lc_template_dn1 TYPE string VALUE 'zsd_dn_tax_inv/zsd_dn_tax_inv'.
    CONSTANTS lc_template_dn2 TYPE string VALUE 'zsd_dn_tax_inv2/zsd_dn_tax_inv2'.
    CONSTANTS lc_template_dn3 TYPE string VALUE 'zsd_dn_tax_inv3/zsd_dn_tax_inv3'.
    CONSTANTS lc_template_hs1 TYPE string VALUE 'zsd_hs_tax_invoice/zsd_hs_tax_invoice'.
    CONSTANTS lc_template_hs2 TYPE string VALUE 'zsd_hs_tax_invoice2/zsd_hs_tax_invoice2'.
    CONSTANTS lc_template_hs3 TYPE string VALUE 'zsd_hs_tax_invoice3/zsd_hs_tax_invoice3'.
    CONSTANTS lc_template_cn1 TYPE string VALUE 'zsd_cn_tax_invoice/zsd_cn_tax_invoice'.
    CONSTANTS lc_template_cn2 TYPE string VALUE 'zsd_cn_tax_invoice2/zsd_cn_tax_invoice2'.
    CONSTANTS lc_template_cn3 TYPE string VALUE 'zsd_cn_tax_invoice3/zsd_cn_tax_invoice3'.
    CONSTANTS lc_template_os1 TYPE string VALUE 'zsd_os_tax_invoice/zsd_os_tax_invoice'.
    CONSTANTS lc_template_os2 TYPE string VALUE 'zsd_os_tax_invoice2/zsd_os_tax_invoice2'.
    CONSTANTS lc_template_os3 TYPE string VALUE 'zsd_os_tax_invoice3/zsd_os_tax_invoice3'.
    CONSTANTS lc_template_gt1 TYPE string VALUE 'zsd_gt_tax_invoice/zsd_gt_tax_invoice'.
    CONSTANTS lc_template_gt2 TYPE string VALUE 'zsd_gt_tax_invoice2/zsd_gt_tax_invoice2'.
    CONSTANTS lc_template_gt3 TYPE string VALUE 'zsd_gt_tax_invoice3/zsd_gt_tax_invoice3'.
    CONSTANTS lc_template_ot1 TYPE string VALUE 'zsd_ot_tax_invoice/zsd_ot_tax_invoice'.
    CONSTANTS lc_template_ot2 TYPE string VALUE 'zsd_ot_tax_invoice2/zsd_ot_tax_invoice2'.
    CONSTANTS lc_template_ot3 TYPE string VALUE 'zsd_ot_tax_invoice3/zsd_ot_tax_invoice3'.
    CONSTANTS lc_template_sto1 TYPE string VALUE 'zsd_sto_tax_invoice/zsd_sto_tax_invoice'.
    CONSTANTS lc_template_sto2 TYPE string VALUE 'zsd_sto_tax_invoice2/zsd_sto_tax_invoice2'.
    CONSTANTS lc_template_sto3 TYPE string VALUE 'zsd_sto_tax_invoice3/zsd_sto_tax_invoice3'.
    CONSTANTS lc_template_ts1 TYPE string VALUE 'zsd_ts_tax_invoice/zsd_ts_tax_invoice'.
    CONSTANTS lc_template_ts2 TYPE string VALUE 'zsd_ts_tax_invoice2/zsd_ts_tax_invoice2'.
    CONSTANTS lc_template_ts3 TYPE string VALUE 'zsd_ts_tax_invoice3/zsd_ts_tax_invoice3'.
    CONSTANTS lc_template_foc1 TYPE string VALUE 'zsd_foc_challan/zsd_foc_challan'.
    CONSTANTS lc_template_foc2 TYPE string VALUE 'zsd_foc_challan2/zsd_foc_challan2'.
    CONSTANTS lc_template_foc3 TYPE string VALUE 'zsd_foc_challan3/zsd_foc_challan3'.
*    CONSTANTS lc_template_credit TYPE string VALUE 'zsd_credit_note/zsd_credit_note'.
...
*    CONCATENATE lv_xml lv_supplier INTO lv_xml.
    ...
    IF printname = 'sto1'.
      lc_template_name = lc_template_bs1.
    ELSEIF printname = 'sto2'.
      lc_template_name = lc_template_bs2.
    ELSEIF printname = 'sto3'.
      lc_template_name = lc_template_bs3.
    ELSEIF printname = 'dom1'.
      lc_template_name = lc_template_ec1.
    ELSEIF printname = 'dom2'.
      lc_template_name = lc_template_ec2.
    ELSEIF printname = 'dom3'.
      lc_template_name = lc_template_ec3.
    ELSEIF printname = 'expo1'.
      lc_template_name = lc_template_dn1.
    ELSEIF printname = 'expo2'.
      lc_template_name = lc_template_dn2.
    ELSEIF printname = 'expo3'.
      lc_template_name = lc_template_dn3.
    ELSEIF printname = 'foc'.
      lc_template_name = lc_template_hs1.
    ELSEIF printname = 'foc2'.
      lc_template_name = lc_template_hs2.
    ELSEIF printname = 'foc3'.
      lc_template_name = lc_template_hs3.
    ELSEIF printname = 'cndn1'.
      lc_template_name = lc_template_cn1.
    ELSEIF printname = 'cndn2'.
      lc_template_name = lc_template_cn2.
    ELSEIF printname = 'cndn3'.
      lc_template_name = lc_template_cn3.
    ELSEIF printname = 'os1'.
      lc_template_name = lc_template_os1.
    ELSEIF printname = 'os2'.
      lc_template_name = lc_template_os2.
    ELSEIF printname = 'os3'.
      lc_template_name = lc_template_os3.
    ELSEIF printname = 'gt1'.
      lc_template_name = lc_template_gt1.
    ELSEIF printname = 'gt2'.
      lc_template_name = lc_template_gt2.
    ELSEIF printname = 'gt3'.
      lc_template_name = lc_template_gt3.
    ELSEIF printname = 'ot1'.
      lc_template_name = lc_template_ot1.
    ELSEIF printname = 'ot2'.
      lc_template_name = lc_template_ot2.
    ELSEIF printname = 'ot3'.
      lc_template_name = lc_template_ot3.
    ELSEIF printname = 'bsto1'.
      lc_template_name = lc_template_sto1.
    ELSEIF printname = 'bsto2'.
      lc_template_name = lc_template_sto2.
    ELSEIF printname = 'bsto3'.
      lc_template_name = lc_template_sto3.
    ELSEIF printname = 'ts1'.
      lc_template_name = lc_template_ts1.
    ELSEIF printname = 'ts2'.
      lc_template_name = lc_template_ts2.
    ELSEIF printname = 'ts3'.
      lc_template_name = lc_template_ts3.
    ELSEIF printname = 'bfoc1'.
      lc_template_name = lc_template_foc1.
    ELSEIF printname = 'bfoc2'.
      lc_template_name = lc_template_foc2.
    ELSEIF printname = 'bfoc3'.
      lc_template_name = lc_template_foc3.
*
*    ELSEIF printname = 'bcn'.
*      lc_template_name = lc_template_credit.
    ENDIF.
